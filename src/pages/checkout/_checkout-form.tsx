...
const CheckoutForm = (props: {
  ...
  return (
    <Fragment>
      <p>
        Bitte fülle das untenstehende Formular aus und teile uns mit, wie wir
        dich bei Fragen erreichen können.
      </p>
      <p>
        Sämtliche Produktpreise verstehen sich inkl. Verpackungs- und
        Versandspesen. Für den Versand ins Ausland können zusätzliche Kosten
        entstehen.
      </p>
      ...
      <p>
        Die Liste der bestellten Artikel sowie die Zahlungsinformationen stellen
        wir dir zusätzlich per Email zu.
      </p>
